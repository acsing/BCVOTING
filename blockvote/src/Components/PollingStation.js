...
import LoadingCircles from '../assets/ericCartman.jpeg'
import LoadingCircles2 from '../assets/kenny.jpeg'

const PollingStation = props => {

const [candidate1URL,changeCandidate1Url]=useState(LoadingCircles)
const [candidate2URL,changeCandidate2Url]=useState(LoadingCircles2)
        ...
        <Container>
            <Row>
                ...
                <Col className='justify-content-center d-flex align-items-center'>
                    ...
                    alignItems:'center',
                    padding:'2vw',
                    textAlign:'center'}}>Vote for your candidate</div>
                </Col>
                <Col className='justify-content-center d-flex'>
                    <Container>
                        <Row style={{marginTop: "5vh", backgroundColor:'#c4c4c4'}}>
